...
byte BWS_01 = 0;
byte last_BWS_01 = 0;
const byte SR_BWS_01 = 0;
const byte Bit_BWS_01 = 0;  // Betriebswahlschalter Position 1 "Werkzeug in OT fahren und sichern"                          --> SR0/Bit0
byte BWS_02 = 0;
byte last_BWS_02 = 0;
const byte SR_BWS_02 = 0;
const byte Bit_BWS_02 = 1;  // Betriebswahlschalter Position 2 "Probe einlegen oder wechseln"                               --> SR0/Bit1
byte BWS_03 = 0;
byte last_BWS_03 = 0;
const byte SR_BWS_03 = 0;
const byte Bit_BWS_03 = 2;  // Betriebswahlschalter Position 3 "Knickrichtungsvorgeber in Positions fahren"                 --> SR0/Bit2
byte BWS_04 = 0;
byte last_BWS_04 = 0;
const byte SR_BWS_04 = 0;
const byte Bit_BWS_04 = 3;  // Betriebswahlschalter Position 4 "Versuchsbereitschaft herstellen und Versuch durchführen"    --> SR0/Bit3
byte BWS_05 = 0;
byte last_BWS_05 = 0;
const byte SR_BWS_05 = 0;
const byte Bit_BWS_05 = 4;  // Betriebswahlschalter Position 5 "Probenentnahme"                                             --> SR0/Bit4
byte BWS_06 = 0;
byte last_BWS_06 = 0;
const byte SR_BWS_06 = 0;
const byte Bit_BWS_06 = 5;  // Betriebswahlschalter Position 6 "Werkzeugwechsel - Von OT nach UT fahren"                    --> SR0/Bit5
byte BWS_07 = 0;
byte last_BWS_07 = 0;
const byte SR_BWS_07 = 0;
const byte Bit_BWS_07 = 6;  // Betriebswahlschalter Position 7 "Bastellstellung - manueller Betrieb"                        --> SR0/Bit6
byte BWS_08 = 0;
byte last_BWS_08 = 0;
const byte SR_BWS_08 = 0;
const byte Bit_BWS_08 = 7;  // Betriebswahlschalter Position 8 "not used" --> Meldung am Display                            --> SR0/Bit7

byte BWS_09 = 0;
byte last_BWS_09 = 0;
const byte SR_BWS_09 = 1;
const byte Bit_BWS_09 = 0;  // Betriebswahlschalter Position 9 "not used" --> Meldung am Display                            --> SR1/Bit0
byte BWS_10 = 0;
byte last_BWS_10 = 0;
const byte SR_BWS_10 = 1;
const byte Bit_BWS_10 = 1;  // Betriebswahlschalter Position 10 "not used" --> Meldung am Display                           --> SR1/Bit1
byte BWS_11 = 0;
byte last_BWS_11 = 0;
const byte SR_BWS_11 = 1;
const byte Bit_BWS_11 = 2;  // Betriebswahlschalter Position 11 "not used" --> Meldung am Display                           --> SR1/Bit2
byte BWS_12 = 0;
byte last_BWS_12 = 0;
const byte SR_BWS_12 = 1;
const byte Bit_BWS_12 = 3;  // Betriebswahlschalter Position 12 "not used" --> Meldung am Display                           --> SR1/Bit3

byte RK_HZ_R_unten;
const byte SR_RK_HZ_R_unten = 1;
const byte Bit_RK_HZ_R_unten = 4;  // Reedkontakt Hubzylinder rechts unten                                   --> SR1/Bit4
byte RK_HZ_R_oben;
const byte SR_RK_HZ_R_oben = 1;
const byte Bit_RK_HZ_R_oben = 5;  // Reedkontakt Hubzylinder rechts oben                                    --> SR1/Bit5
byte RK_HZ_L_unten;
const byte SR_RK_HZ_L_unten = 1;
const byte Bit_RK_HZ_L_unten = 6;  // Reedkontakt Hubzylinder links unten                                    --> SR1/Bit6
byte RK_HZ_L_oben;
const byte SR_RK_HZ_L_oben = 1;
const byte Bit_RK_HZ_L_oben = 7;  // Reedkontakt Hubzylinder links oben                                     --> SR1/Bit7

byte RK_KRV_innen;
const byte SR_RK_KRV_innen = 2;
const byte Bit_RK_KRV_innen = 0;  // Reedkontakt Knickrichtungsvorgeber innen                               --> SR2/Bit0
byte RK_KRV_aussen;
const byte SR_RK_KRV_aussen = 2;
const byte Bit_RK_KRV_aussen = 1;  // Reedkontakt Knickrichtungsvorgeber außen                               --> SR2/Bit1
byte RK_WZS_innen;
const byte SR_RK_WZS_innen = 2;
const byte Bit_RK_WZS_innen = 2;  // Reedkontakt Werkzeugsicherung innen                                    --> SR2/Bit2
byte RK_WZS_aussen;
const byte SR_RK_WZS_aussen = 2;
const byte Bit_RK_WZS_aussen = 3;  // Reedkontakt Werkzeugsicherung außen                                    --> SR2/Bit3
byte S_HZ_hoch;
const byte SR_S_HZ_hoch = 2;
const byte Bit_S_HZ_hoch = 4;  // Schalter Hubzylinder nach oben fahren                                  --> SR2/Bit4
byte S_KRV_rein;
byte last_S_KRV_rein = 0;
const byte SR_S_KRV_rein = 2;
const byte Bit_S_KRV_rein = 5;  // Schalter Knickrichtungsvorgeber nach innen fahren                      --> SR2/Bit5
byte S_KRV_raus;
const byte SR_S_KRV_raus = 2;
const byte Bit_S_KRV_raus = 6;  // Schalter Knickrichtungsvorgeber nach außen fahren                      --> SR2/Bit6
                                // LEER                                                                   --> SR2/Bit7

byte BT;
byte last_BT = 0;
const byte SR_BT = 3;
const byte Bit_BT = 0;  // Bestätigungstaster                                               --> SR3/Bit0
byte DS_Festo;
const byte SR_DS_Festo = 3;
const byte Bit_DS_Festo = 1;  // Druckschalter Festo                                              --> SR3/Bit1
...
byte MagVen_HZ = 0;
const byte SR_MagVen_HZ = 0;
const byte Bit_MagVen_HZ = 0;  // Magnetventil Hubzylinder                             --> SR0/Bit0
byte MagVen_KRV_rein = 0;
const byte SR_MagVen_KRV_rein = 0;
const byte Bit_MagVen_KRV_rein = 1;  // Magnetventil Knickrichtungsvorgeber rein             --> SR0/Bit1
byte MagVen_KRV_raus = 0;
const byte SR_MagVen_KRV_raus = 0;
const byte Bit_MagVen_KRV_raus = 2;  // Magnetventil Knickrichtungsvorgeber raus             --> SR0/Bit2

byte Led_Gruen = 0;
const byte SR_Led_Gruen = 1;
const byte Bit_Led_Gruen = 0;  // Gruene Led                                                             --> SR1/Bit0
byte Led_Gelb = 0;
const byte SR_Led_Gelb = 1;
const byte Bit_Led_Gelb = 1;  // Gelbe Led                                                              --> SR1/Bit1
byte Led_Rot = 0;
const byte SR_Led_Rot = 1;
const byte Bit_Led_Rot = 2;  // Rote Led                                                               --> SR1/Bit2
